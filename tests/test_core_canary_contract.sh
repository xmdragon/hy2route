...
for literal in 'sha256sum' 'local_generator' 'canary_source' 'trap cleanup' 'nft list table inet hy2route_canary' 'GOMEMLIMIT=64MiB' 'ssh "root@$router"' '[ ! -e "$backup" ]' 'preflight_backup' 'SSH_CONNECTION' 'fwmark=104' 'bypass_mark=103' 'hy2route-core-canary-guard'; do
